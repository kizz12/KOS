...
if sPath=="startup" or sPath=="users" or sPath=="newuser" or sPath=="master" or sPath=="guest" or sPath=="door" or sPath=="edit" or sPath=="extend" or sPath=="help" or sPath=="log" or sPath=="logout" or sPath=="delete" then
