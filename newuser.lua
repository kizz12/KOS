...
if user==1 then
	...
	print'Please enter the desired username, or exit to exit:'
	uncrt=read()
	if uncrt=="exit" then
	return
	end
	...
	if uncrt==nil or uncrt=='' or uncrt=='.' or unpass==nil or unpass=='' or unpass=='.' then
	print'Invalid username or password!'
	sleep(1)
	return
	end	
	local stringToHash = unpass
